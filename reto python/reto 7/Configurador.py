...
# Comprobar si existe la carpeta y el archivo de configuracion
    ...
    def read_config(self):
	    ...
	    with open(self.path/self.config) as file:
               ...
               vfiltro=configuration_file ["directorios1"]["filter"]
               ...
               if not os.path.exists(vrutao):
                 os.mkdir(vrutao)
               # Comprobar accion
               accion(vrutai,vrutao,vaccion,vfiltro)
               # Comprobar ruta in 2
               ...
               vfiltro=configuration_file ["directorios2"]["filter"]
               if not os.path.exists(vrutai):
                 os.mkdir(vrutai)
               ...
               vfiltro=configuration_file ["directorios3"]["filter"]
               if not os.path.exists(vrutai):
                 os.mkdir(vrutai)
